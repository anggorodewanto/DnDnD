...
2026-05-11T?? | rxprompt | med-27, med-29, med-30, med-43 | single orchestrator session — reaction-prompt helper (ReactionPromptStore) + three posters (counterspell, metamagic, class-feature); med-27 flipped done with FoW two-range light tracked as separate renderer follow-up | committed 0501d7b
