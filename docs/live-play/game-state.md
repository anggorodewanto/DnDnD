...
- **Immediate spotlight (on the players):** pick a **destination** — The Mask Market of Sesh / Morran's Reach /
  The Palewatch — and **how to travel** (moor-road on foot / hire a caravan / the river), talked out in
  #in-character; Windreth may answer Vale's "why are you here?". When they pick, **build it live as fresh
  unprepped territory** (record durable lore in world.md). See the Next-action line below.
