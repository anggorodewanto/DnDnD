...
1. **▶ THE COLD VAULT IS WON — the party is out of combat, free in the cleared vault.** The keeper (encounter
   ...
   action and never narrate their choices** (per [`dm-rules.md`](dm-rules.md)).
