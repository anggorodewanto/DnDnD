...
**★ Now: 🛡 FORGE HELD AND THE MAN WENT AROUND HIM. Athletics 22 vs DC 13 (d20 15 + 5, plus a
player-declared 1d4 that was not needed). CONTACT HAPPENED AND DID NOT REGISTER AS A BODY: shoulder to
breastplate, the practising hand came up and READ him three fingers flat, decided PLATE = a post left
in the aisle, stepped six inches wide, GRUNTED ONCE like a man at the end of a shift, and kept walking
without ever looking. 🔎 THE SUCCESS PAID INFORMATION, not just safety: THE REACH NEVER PAUSED — the
fingers kept counting straight through the touch, ON FORGE'S BREASTPLATE. He has the real weight of a
tired man; he is cold and damp all the way through; and the grunt means SOMEBODY IS IN THERE AND WAS
ANNOYED. ⚠ 5th refusal: that is what he is LIKE, not what he IS. 🗺 THE FLOOR NOW HAS A JOG IN IT —
the quarter-inch rut he has worn for eleven years bends six inches around a place where nothing usually
stands. What that means was NOT stated; it is the players' read. ⚖ RULING SAID OUT LOUD: A DIE LANDING
ON ONE LINE DOES NOT CLOSE THE FREE OPTIONS ON THE OTHER. Forge threw his die on Forge's rut, so VALE
AND WINDRETH EACH STILL HAVE ALL THREE DOORS OPEN — step off (free, no roll, visible in lamplight) ·
THE SEVENTH PLACE, off the lines (flat board state, no recommendation, no trap) · hold and roll DC 13,
their pick of verb (Acrobatics *be somewhere he is not* / Athletics *be the wall he already thinks you
are*), each resolved on its own, nobody carrying anybody. ⏱ THE SECOND MAN IS TWO FEET OUT ON THE FAR
RUT AND HAS ADJUSTED FOR NOTHING. One thing each. STILL NOT COMBAT. 🔁 RETURN TRIP IN ~1 MIN CARRYING
BALES — and one flat fact given with the conclusion refused: A MAN CARRYING A BALE HAS BOTH HANDS FULL,
so the reach is occupied for the whole climb. Stated as fact, explicitly NOT as advice, NOT safer and
...
the mysterious boy to knock again. And then we will follow the boy."*** Table had agreed OOC in
#player-chat first (*"banting setir nyari si anak itu"*). **Windreth silent again, and again nothing was
taken from him for it.** Resolved exit + travel + arrival as ONE beat; no dice asked, none owed.

- **🗝 THE LOW LANE PAID OFF — FIRST USE, AND IT WORKED EXACTLY AS SHE SAID.** Wet to the ankle,
  stooping, out through a coal cut behind a chandler's into an ordinary street at an ordinary hour.
  **The washer's unprompted gift was good. The mercy branch has now paid the party something real, and
  the binding promise about her stands untouched.**
- **🔔 THE ANNOUNCED CLOCK FIRED ON SCHEDULE AND THEY WERE NOT IN THE ROOM FOR IT.** Bells came
  thin over the roofs while they stood on the landing. **The reader is walking in to a stand holding
  blank paper and no book.** Told to them flat, in the same post, no countdown: *"You are four streets
  away and nobody is looking for you."* No hidden clock, no punishment — the timer I announced simply
  arrived.
- **🧍 THE CLERK DID NOT ASK WHERE THEY WERE GOING.** Held the west door outward because he opens
  and closes things, closed it, walked thirty feet back to his bench past six men who did not look up,
  sat, laid his palms flat. **The squared quire is still on the stand, ink set, untouched.**
- **🚪 NEW LOCATION: the cooper's, four streets on — an outside timber stair, three landings, one
  flight each. Third landing, one door, no light under it, no sound behind it.** That door is the
  clerk's own, per what Vale bought: *"Third landing, off the stair behind the cooper's."*
- **⚠ NEW FACT PLANTED, MEANING WITHHELD — THE DOOR IS WORN AT BELT HEIGHT.** A patch of bare grey
  timber a hand's width across, **not at the latch, not where a man's knuckles fall** — down at Vale's
  belt, through the paint and through the grain beneath, **one spot, nothing scattered above it and
  nothing below.** Eleven years of the same fist from the same height. Said in public: *"That is a fact
  on a door. I am still not telling you what he is."* **Refusal about what the boy IS still holds; the
  height he showed them with his own hand is now physically corroborated on timber, and the read is
  theirs.**
- **🚫 THE TRIGGER IS NOT ARMED, AND IT WAS GIVEN AS TWO FACTS, NOT A RE-EXPLAINED RULING:
  *"Nothing knocked. The stand you walked away from is not empty."*** They already hold the switch in
  the clerk's own words (*"He only comes when the stand is empty"*). **Deliberately did not re-lecture
  it** — the connection, and the choice to go back and operate it, stays entirely theirs. What operating
  it costs is still unstated.
- **🪜 LIVE PHYSICAL PROBLEM, PLACEMENT FREE: one stair, one way up and one way down.** Above the
  door = behind him when he leaves. Below it = in front of him, he walks into you. The cooper's yard =
  sees the stair, not the door. **Ruled in public: picking a position costs no roll.**
...
**Windreth never answered.** No rolls in #roll-history, queue empty. Resolved the lot rather than
spending another beat on two missing d20s:

- **⚖ THE DC 13 WAS NOT WAIVED — IT WAS PAID FORWARD BY FORGE'S 22.** The six-inch jog planted last
  beat (fact given, meaning withheld) is what closed the other lines: **the second man hit the jog and
  took it without knowing why, and the four behind him followed the man in front.** Stated in public in
  exactly those terms so it reads as the party's success cashing, not as an announced stake going soft.
  **Nothing touched anyone. Nothing was taken from Windreth for his silence.**
- **💡 REAL BOARD CHANGE, AND IT IS PERMANENT: THE LAMP STAYS.** The cart went back down the chain on
  its own weight; **the lamp stays hooked over the south arch because the cart comes again and nobody
  hangs a lamp twice.** The Reading Room is lit now and stays lit — **darkvision 60 is dead as an edge
  for the rest of this sequence.** This is the delivery's price, and it bit without punishing anyone.
- **🧍 Six men, six trestles, seventh empty and cold** (washer's, per the standing mercy promise —
  still not a hook). **The floor is the party's again**, and **not one of the six looked at the stand
  or at the blank quire on it** on the way past — reinforces the mechanism read without confirming it.
- **⏰ ~20 MINUTES TO THE BELLS.** The clerk is still beside the squared quire with the ink set,
  waiting for a voice. The reader's *"Do you have a name for me?"* is still unanswered.
- **Live, unpicked, and deliberately NOT re-listed in the post** (the repetition the table flagged):
  line eight · the boy's switch (*"he only comes when the stand is empty"*) · the address on the third
  landing · asking the clerk to say nothing (free, no roll) · the lamp six feet from a room of wet paper.

**⏩ PACING CORRECTION — DM-SIDE, TAKEN 07-30 AND POSTED IN PUBLIC** (#in-character
`1532281575826522223`). Table direction, second time: *"you are going down to too detailed beat by beat
again. Also, make your in-character posts more compact, less repetition."* **The offender was me, not
the party:** this one crossing ran as **four beats** by zooming 30 ft → 4 ft → 2 ft → six inches and
resolving one NPC / one PC per post. **From here the whole crossing is ONE exchange, out and back.**
Forge is settled at 22. **Vale and Windreth each owe one line — step off (free) or DC 13, their verb —
and whatever arrives next resolves the lot in a single post: the pass, the bale climb, and where the six
leave the party standing when the floor is theirs again.** No more distance countdowns; announce and
resolve in the same post. #in-character posts target ~150–250 words with every already-made ruling cut.
Written into `docs/live-play/dm-rules.md` → "At the table". ⏰ **~20 MIN TO THE BELLS.**

**🛡 THE CONTACT, RESOLVED** (Forge's own declaration + his own die: `/check` Athletics, d20 15 + 5 +
1d4 2 = **22** vs DC 13, filed and resolved through the DM Queue). The player's in-table line was
*"nek meh liwat, yo liwat'o, rasah nabrak2"* and that is exactly what got rolled: **he did not yield an
inch.** The man's shoulder met breastplate; there was leather, wet cloth, and the dull knock of weight
against metal that does not give. **The practising hand came up and read him** — three fingers laid
flat, *"the way a man in the dark checks whether the thing in front of him is the doorframe or the
doorway"* — cold, damp through, nails wide and soft. **And the hand decided: plate, standing where
nothing usually stands, therefore a post, a barrow left in the aisle.** Six inches wide, one grunt,
gone. **No alert, nothing turned, nobody stopped.**

**🔎 WHAT A 22 BOUGHT BEYOND NOT-BEING-TOUCHED** (successes pay information in this room):
**the reach never paused** — the fingers kept curling and opening on the same eleven-year count
straight through the contact, **and for two seconds they were counting on Forge's chest**; he carries
**the real weight of a tired man**; he is **cold and damp all the way through**; and **he grunted**,
which is the smallest sound in the room and the worst thing in it, because it is the sound a man makes
when somebody has left something where he walks. **Somebody is in there. Somebody was annoyed.**
⚠ **Fifth refusal, stated in public: that is what he is LIKE. What he IS stays refused.**

**🗺 THE JOG IN THE RUT.** The line he has worn a quarter-inch into stone now bends six inches around
a place where nothing usually stands — and he walks it again, loaded, in about a minute. ⚠ **Given as
a visible fact with the meaning deliberately withheld.** *(Not a book, not a name — do not explain it
for them.)*

**⚖ THE PER-LINE RULING** (new, and stated before it could look like a trick): *free until a die is
thrown* is **per line, not per table.** Forge's die closed Forge's rut only. **Vale and Windreth are
each still fully free**, and the second man being two feet out does not retroactively convert their
silence into a hold. Nothing was rolled for them and nothing will be.

Fiction #the-story `f0f367a0-f5f2-490b-84f3-2fc6b86dc760`; queue resolution posted to #in-character by
the resolver (`d9775b5c-1659-49ca-b7a9-32eafb0ee080` → resolved); mechanics #in-character
`1532254934739714078` / `1532254937075941529`.

**Prior (07-30 ~04:51Z) — four feet, and nobody has looked at you yet:**
...
beat, ZERO dice**). Third restatement of the ruling: **a check beats *unwillingness* and he has none;
the ceiling is his KNOWLEDGE.** He answered **without turning around**, palms flat on the quire,
speaking to the empty page. Bought: **an address — *"My door. Third landing, off the stair behind the
cooper's."*** · **a height — his hand out in the dark at belt level, *"Here. Eleven years. It has never
once come up."*** · **no face, not ever** — never opened the door fast enough, and the once he saw
anything it was a back already going down · 🔑 **AND THE SWITCH, GIVEN UNASKED: *"He will not come
tonight. He only comes when the stand is empty."*** **They have emptied that stand before and know
exactly how.** What operating it *costs* was deliberately not stated. 🚫 **FOURTH REFUSAL about him: not
telling them what the boy IS.** Not confirmed, not denied — *"immortal" remains the players' word.*

**🚶 THE LIVE PHYSICAL PROBLEM — NOT SOCIAL, NOT COMBAT.** Six worn lines from the trestle rows (troughs
at rows 4 and 9, D–O) converge on the arch (cols I–J); **two run through the party's mid-floor
squares.** Ruled in public: **being unseen is FREE** (the six have no apparatus for noticing a person —
"a d20 needs something to overcome and there was nothing"); **being untouched is NOT.** Options given:
**step off the line = free, no roll** · **hold and let them pass = a roll, PRE-DECLARED before the die
per the standing rule.** ⚠ **What a bump costs was explicitly NOT pre-answered** — *"a man who walks
into a person in this room will not know what he has walked into."*

Fiction #the-story `a0f5cfee-9dae-46eb-b85e-ce3bc08cd659`; mechanics #in-character
`1532220103859372072` / `1532220105730297987` / `1532220107495833750`.

**Prior (07-30 ~02:37Z) — the delivery clock firing:**

**⏳ THE DELIVERY ARRIVES — THE ANNOUNCED CLOCK, NOT AN AMBUSH.** Fired on a beat with **no player
declaration pending** (only a To-DM and OOC chat), deliberately: the world moves while they decide.
Fairness stated in public before anything resolved, quoting the reader's own line back — ***"I am
expecting a delivery. You are not it." … "You may wait."*** — logged at `:1088` as **a clock rather
than an explanation**, timing withheld, *and they were told they could simply ask him when.* They
spent that time elsewhere and it all paid. **No blame, no gotcha, and explicitly NOT a price for the
mercy.** What is on the other end of the wheel is **not yet visible and was not explained.**

**🔄 THE NAME-RULE INVERTED RATHER THAN BROKE — always the intended shape.** Four beats of *"a door
is not a name"* still hold: **they are not reacting to the party now either.** They stopped for
**work arriving**, the one category of event the room has apparatus left for. Not a retcon. Restated
in-post: **do not read a name aloud in this room unless that is the choice being made.**

**🕯 THE MAN AT THE STAND WILL NOT WARN THEM** — hands on the quire because a delivery means the
stand is about to be used. He volunteers nothing and **answers anything truthfully if asked**, because
nobody ever told him not to. **Board state; not betrayal, not a mercy tax.**

**❓ TO-DM ANSWERED (JonathanEka 14:09, *"battle with the immortal boy or a normal encounter?"*).**
Table-level and honest: **no boss fight is parked and waiting**; combat happens when the fiction earns
it or a player picks it, and the no-hidden-clocks promise covers the run-up. 🚫 **Refused: what the
boy is.** *"Immortal" is their word, neither adopted nor denied.* The boy was named a **real, live,
pullable thread** (two knocks · a fist still a boy's fist · the stair he went down without looking
back) — pull it and it answers; guessing at the DM does not.
Fiction #the-story `a5192d27-da68-4d5e-87be-5580150b033c`; mechanics #in-character
`1532215515823603874` / `1532215517455061002` / `1532215519170793525`.

**Prior (07-29 ~12:10Z) — going back inside:**

**🚪 BACK INSIDE THE READING ROOM — NO ROLL, NO CHECK, NO NOISE** (declared 12:08: *"let's go in
now" says Vale*). He got off the bench, unlocked the low iron-banded west door with the cord key and
**went in first, because he is always first**, then **closed it behind them, because he always closes
it.** Cost ~2 minutes off the hour. Map `6081877c…` is the live board again (18×12, west-wall gap
rows 6–7, outflow arch south cols I–J, stand at Q6, ordinary dark + darkvision 60 all round).

**🧍 THERE ARE SIX.** The seventh trestle is where the washer left it, **the water in front of it flat,
cold and skinned, and nobody moved into the gap or took up her share** — six work at the pace six
worked at when there were seven. ⚠ **Said in public, unprompted: this is NOT a hook and NOT a thread
about her; she walked, she is gone, she is fine, and the binding promise stands** — her fate is not a
trap. *The room simply has a hole in it and no way to notice one.*
🚫 **The name-rule held a FOURTH time: nobody looked up. "A door is not a name."** Restated unsoftened
in-post: **do not read a name aloud in this room unless that is the thing you are choosing to do.**

**📄 THE STAND — WHAT THE CLOCK IS ACTUALLY COUNTING TOWARD.** He crossed without looking at the six
(*"you learn not to look at the stand"* — and he has spent eleven years learning not to look at
anything else), found it empty, **did not react**, and set up: **quire down, squared twice, inkhorn,
nib, sand shaker on the right.** He now stands with his hands at his sides waiting for a voice.
**When the bells go and the reader walks in, a NEW BOOK STARTS.**

**💧 THE TROUGHS — GIVEN FREE, NO ROLL, AND WHY.** Looking into an open trough in a room where nobody
objects to being looked at is not a Search, **and the identification was already PAID FOR by the 20+
Investigation tier** (*one hand, start to finish, no second pen*). The pulp has not finished being
paper: thumbnail pieces still holding ruling, cut edges, a squared page corner, **and writing on some
of them — three letters, half a word, a numeral pressed heavier.** ⚡ **ALL ONE HAND. IT IS HIS HAND.**
⚠ **Explicitly NOT explained: what the water is for, or what it says about the book in their bag —
evidence, not proof, the read stays theirs** (`campaign-arc.md:184` holds; same treatment as the
blank quire and *"There must have been."*).
Fiction #the-story `29b64de5-5071-42c5-ad9a-fc31477bb754`; mechanics #in-character
`1531997579330715700` / `1531997581448843416`.

**Prior (07-29 ~11:56Z) — the second interrogation and the release:**
