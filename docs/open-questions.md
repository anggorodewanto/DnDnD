...
34. **OA prompts stall combat.** The system prompts players for opportunity attacks when an enemy moves away. Does combat pause until the player responds? What is the timeout? This conflicts with the "zero stalling" design goal.
