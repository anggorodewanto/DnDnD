...
| 37 | A-H02 | High | done | OAuth access/refresh tokens stored in plaintext | internal/auth/session_store.go:50-62 + db/migrations/20260310120001_create_sessi... |
...
| 86 | F-H08 | High | done | Reaction declarations not validated for the type's prerequisites | /home/ab/projects/DnDnD/internal/combat/reaction.go:27-46 |
...
| 118 | I-H10 | High | done | Race speed table is hard-coded; ignores DB and homebrew races | /home/ab/projects/DnDnD/internal/dashboard/charcreate.go:204-217 |
...
| 146 | A-M13 | Medium | done | HP recompute on multiclassing assumes secondary classes never reach level 1 with max die | internal/character/stats.go:30-42 |
...
| 152 | B-M05 | Medium | done | No validation that `position_col` / `position_row` are inside the map bounds | `/home/ab/projects/DnDnD/internal/combat/service.go:863-913` |
...
| 158 | B-M11 | Medium | done | Map `UpdateMap` allows shrinking width/height without re-clipping `tiled_json` | `/home/ab/projects/DnDnD/internal/gamemap/service.go:124-151`. |
...
| 164 | C-M05 | Medium | superseded | Off-hand TWF doesn't track on AttackerHidden / invisible attacker single-shot reveal | /home/ab/projects/DnDnD/internal/combat/attack.go:1238-1247 (`OffhandAttack`) |
...
| 184 | D-M11 | Medium | skipped | Resolution priority places `EffectModifyAttackRoll` and `EffectModifySave` at the same priority as immunities-after — but advantage cancellation is a later step | /home/ab/projects/DnDnD/internal/combat/effect.go:134 (`EffectPriority`) |
| 185 | D-M12 | Medium | skipped | EffectGrantImmunity stores condition immunities in the same slice as damage immunities | /home/ab/projects/DnDnD/internal/combat/effect.go:322 |
| 186 | D-M13 | Medium | skipped | Resource_on_hit prompt only fired by Divine Smite, not by feature declarations | /home/ab/projects/DnDnD/internal/combat/class_feature_prompt.go and /home/ab/pro... |
...
| 192 | E-M04 | Medium | skipped | Help action duration tied to ally's turn, not helper's turn | `/home/ab/projects/DnDnD/internal/combat/standard_actions.go:254-261` (`SourceCo... |
...
| 196 | E-M08 | Medium | done | Ritual casting only validates primary class, ignoring multiclass | `/home/ab/projects/DnDnD/internal/combat/spellcasting.go:432-438` |
| 197 | E-M09 | Medium | skipped | AoE save DC pre-subtracts cover bonus but stores no roll-side trace for full cover exclusion | `/home/ab/projects/DnDnD/internal/combat/aoe.go:545-562` |
| 198 | E-M10 | Medium | skipped | OA detection uses `IsNpc` faction check, breaks for PC-vs-PC combat | `/home/ab/projects/DnDnD/internal/combat/opportunity_attack.go:106-108` |
...
| 204 | E-M16 | Medium | skipped | Concentration save uses `currentConcentration` name-string only (no spell ID) | `/home/ab/projects/DnDnD/internal/combat/concentration.go:36-45` (`CheckConcentr... |
...
| 207 | E-M19 | Medium | skipped | Subtle Spell does not actually suppress concentration-break-in-silence | `/home/ab/projects/DnDnD/internal/combat/concentration.go:126-135` (`CheckConcen... |
...
| 209 | F-M01 | Medium | skipped | Readied-spell concentration written with empty SpellID | /home/ab/projects/DnDnD/internal/combat/readied_action.go:126-141 |
...
| 212 | F-M04 | Medium | skipped | Magical-darkness zone affected-tiles ignore concentration-anchored zone movement | /home/ab/projects/DnDnD/cmd/dndnd/discord_adapters.go:819-833 |
...
| 214 | F-M06 | Medium | skipped | Hide-success token visibility doesn't propagate to enemy renders | /home/ab/projects/DnDnD/internal/combat/standard_actions.go:363-371 |
...
| 216 | F-M08 | Medium | superseded | `equipWeapon` accidentally drops the Defense fighting style AC bonus when re-equipping | /home/ab/projects/DnDnD/internal/combat/equip.go:141-184 |
| 217 | F-M09 | Medium | skipped | Spell-slot deduction for readied actions runs even when the spell needs no slot | /home/ab/projects/DnDnD/internal/combat/readied_action.go:68-75 |
| 218 | F-M10 | Medium | skipped | No reaction-used reset for legendary actions / lair actions in cross-turn sequencing | /home/ab/projects/DnDnD/internal/combat/legendary.go (entire file) |
| 219 | F-M11 | Medium | skipped | Auto-resolve cancels reaction declarations instead of marking specific Counterspell/OA as forfeited | /home/ab/projects/DnDnD/internal/combat/timer_resolution.go:314-321 |
...
| 221 | F-M13 | Medium | skipped | Multiattack parser falls back to "use every attack once" — wrong for skirmishers | /home/ab/projects/DnDnD/internal/combat/turn_builder.go:309-395 |
| 222 | F-M14 | Medium | skipped | Reaction one-per-round resets between rounds but not at "creature's turn start" exactly | /home/ab/projects/DnDnD/internal/combat/reactions_panel.go:79-104 |
| 223 | F-M15 | Medium | skipped | No range / 60ft check for Counterspell when generating its prompt | /home/ab/projects/DnDnD/internal/combat/counterspell.go (entire file) |
| 224 | F-M16 | Medium | done | Free interaction matches "open" prefix → routes "open the heavy chest" away from DM | /home/ab/projects/DnDnD/internal/combat/interact.go:11-24 |
...
| 233 | G-M09 | Medium | skipped | Loot pool created from "completed" encounter — combatants gold lost if encounter status mismatch | internal/loot/service.go:67-118 |
...
| 246 | H-M06 | Medium | done | Token redemption isn't atomic with character creation (race window) | /home/ab/projects/DnDnD/internal/portal/builder_service.go:237 |
| 247 | H-M07 | Medium | done | No CSRF protection on portal POST /portal/api/characters | /home/ab/projects/DnDnD/internal/portal/api_handler.go:193 (`SubmitCharacter`) |
...
| 258 | I-M02 | Medium | done | Undo-of-undo re-applies the same undo instead of redoing | /home/ab/projects/DnDnD/internal/combat/dm_dashboard_undo.go:103-113 |
| 259 | I-M03 | Medium | skipped | Pending-action resolve effect: no audit row per effect, after-state misses post-damage hooks | /home/ab/projects/DnDnD/internal/combat/dm_dashboard_handler.go:255-303, 423-441 |
| 260 | I-M04 | Medium | skipped | Character Overview lacks live HP/condition snapshots | /home/ab/projects/DnDnD/internal/characteroverview/service.go:24-39 ; dashboard/... |
| 261 | I-M05 | Medium | done | DM action-resolver "move" effect doesn't write to action log even via effects | /home/ab/projects/DnDnD/internal/combat/dm_dashboard_handler.go:400-421 |
...
| 264 | I-M08 | Medium | skipped | Spell selection isn't filtered by class or capped at max spell level on submit | /home/ab/projects/DnDnD/internal/dashboard/charcreate.go:11-25 ; charcreate_hand... |
...
| 266 | I-M10 | Medium | skipped | Reaction panel resolve/cancel calls aren't atomic with turn-lock | /home/ab/projects/DnDnD/internal/combat/handler.go:461-498 (ResolveReaction/Canc... |
...
| 268 | I-M12 | Medium | skipped | Homebrew create/update has no structural validation beyond name | /home/ab/projects/DnDnD/internal/homebrew/service.go:99-145 |
| 269 | I-M13 | Medium | skipped | DM Override "spell slots" endpoint does not log per-character before-state for audit diff | /home/ab/projects/DnDnD/internal/combat/dm_dashboard_undo.go:594-659 |
...
| 273 | I-M17 | Medium | done | Manual char creation handler ignores starting-equipment "guaranteed:N" quantity | /home/ab/projects/DnDnD/internal/dashboard/charcreate_handler.go (loadStartingEq... |
| 274 | I-M18 | Medium | skipped | Manual character creation can submit ability scores violating point-buy without method gating | /home/ab/projects/DnDnD/internal/dashboard/charcreate.go:67-77 |
| 275 | I-M19 | Medium | skipped | Reactions panel resolve flow doesn't post correction to #combat-log | /home/ab/projects/DnDnD/internal/combat/handler.go:461-498 |
...
| 277 | I-M21 | Medium | skipped | HomebrewEditor list endpoint includes `?homebrew=true` but services don't filter by that query param | /home/ab/projects/DnDnD/dashboard/svelte/src/HomebrewEditor.svelte:60-72 ; statb... |
...
| 280 | J-M03 | Medium | skipped | Crash-recovery loses in-memory once-per-turn slot tracker (Sneak Attack double-use risk) | /home/ab/projects/DnDnD/internal/combat/service.go:323-324 (`usedEffects map`) |
| 281 | J-M04 | Medium | skipped | Hub broadcast drops slow clients but never closes their writer goroutine's conn | /home/ab/projects/DnDnD/internal/dashboard/ws.go:77-101 |
| 282 | J-M05 | Medium | done | Campaign #the-story announcer resolves channel by name on every announce (drift if renamed) | /home/ab/projects/DnDnD/internal/discord/narration_poster.go:71-82 (`resolveStor... |
...
| 284 | J-M07 | Medium | skipped | Tiled import accepts massive maps up to `HardLimitDimension` with no tile-count guard | /home/ab/projects/DnDnD/internal/gamemap/import.go:88-103 (`checkHardRejections`... |
| 285 | J-M08 | Medium | skipped | Tiled `version`/`tiledversion` not validated | /home/ab/projects/DnDnD/internal/gamemap/import.go:55-84 (`ImportTiledJSON`) |
| 286 | J-M09 | Medium | skipped | Open5e cache silently rewrites partial monster data with defaults instead of skipping | /home/ab/projects/DnDnD/internal/open5e/cache.go:110-156 (`monsterToParams`) |
| 287 | J-M10 | Medium | done | dm-queue Post stores `messageID = itemID` placeholder on Send failure → Resolve/Cancel later 404s | /home/ab/projects/DnDnD/internal/dmqueue/notifier.go:163-186 (`Post`) + 200-218 ... |
| 288 | J-M11 | Medium | skipped | Tiled import silently strips group layers but doesn't preserve child-layer property inheritance | /home/ab/projects/DnDnD/internal/gamemap/import.go:115-119 (group flattening) |
| 289 | J-M12 | Medium | skipped | Action handler exploration cancel doesn't strike-through dm-queue item | /home/ab/projects/DnDnD/internal/discord/action_handler.go:495-509 + `performExp... |
| 290 | J-M13 | Medium | skipped | Action handler combat cancel allows incapacitated combatants but block path treats them equally | /home/ab/projects/DnDnD/internal/discord/action_handler.go:368-380 |
| 291 | J-M14 | Medium | skipped | Registration dm-queue posts bypass the unified `dmqueue.Notifier` | /home/ab/projects/DnDnD/internal/discord/registration_handler.go:312 (`postDMQue... |
| 292 | J-M15 | Medium | skipped | Reaction-handler stash leaks: declarations that get DM-resolved don't clear itemIDs map | /home/ab/projects/DnDnD/internal/discord/reaction_handler.go:178-185 (stash on P... |
| 293 | J-M16 | Medium | skipped | dashboardCampaignLookup `IsDM(true)` is not the same as `IsCampaignDM(specific id)` for WS gate | /home/ab/projects/DnDnD/internal/dashboard/dm_middleware.go:48-75 (`RequireDM`);... |
| 294 | J-M17 | Medium | skipped | /action freeform combat-mode skips turnGate when no gate is wired (tests-only path leaks to prod) | /home/ab/projects/DnDnD/internal/discord/action_handler.go:300-309 (the `else if... |
| 295 | J-M18 | Medium | skipped | /distance handler not visible in scope but several Phase-105 handler tests use a typed-nil interface trap | /home/ab/projects/DnDnD/cmd/dndnd/discord_handlers.go:186-200 (the `if deps.quer... |
| 296 | cross-cut-M01 | Medium | superseded | `CalculateHP` only awards the level-1 max die to `classes[0]` | `internal/character/stats.go:21-47`. |
...
| 299 | cross-cut-M04 | Medium | skipped | `evaluateACFormula` silently drops unknown tokens (DEX/DEX cap of medium armor not enforced) | `internal/character/stats.go:91-115` |
...
| 305 | cross-cut-M10 | Medium | skipped | Pact magic slot recovery on short rest restores slot count but not slot level | `internal/rest/rest.go:235-241`. |
| 306 | cross-cut-M11 | Medium | skipped | `ApplyDamageAtZeroHP` does not itself enforce the Massive Damage rule | `internal/combat/deathsave.go:157-192` |
...
| 310 | A-L04 | Low | skipped | Class entries don't expose Eldritch Knight / Arcane Trickster as third-caster subclasses | internal/refdata/seed_classes.go (Fighter & Rogue blocks) |
...
| 314 | A-L08 | Low | skipped | Bot session race in `Bot.HandleGuildCreate` | internal/discord/bot.go:86-90 |
...
| 320 | B-L04 | Low | skipped | Encounter `display_name` not validated against length / control characters | `/home/ab/projects/DnDnD/internal/encounter/service.go:44-62`. |
| 321 | B-L05 | Low | skipped | Asset uploads have no per-campaign quota or count cap | `/home/ab/projects/DnDnD/internal/asset/handler.go:31-83`, |
...
| 325 | C-L02 | Low | skipped | `IsInLongRange` always returns false for melee weapons — but thrown melee in long range handled separately | /home/ab/projects/DnDnD/internal/combat/attack.go:148-155, 538-542 |
...
| 327 | C-L04 | Low | skipped | `ApplyDamageResistances` reason string lowercase-mixed | /home/ab/projects/DnDnD/internal/combat/damage.go:24-46 |
...
| 336 | D-L04 | Low | skipped | WildShape CR limit returns float64 — comparisons against parsed CR strings are exact | /home/ab/projects/DnDnD/internal/combat/wildshape.go:59 |
...
| 340 | E-L02 | Low | skipped | Stand from prone does not require movement to be available beyond cost | `/home/ab/projects/DnDnD/internal/combat/standard_actions.go:592-595` |
...
| 343 | E-L05 | Low | skipped | `IsBonusActionSpell` uses substring match — fragile against locale/whitespace | `/home/ab/projects/DnDnD/internal/combat/spellcasting.go:23-25` |
| 344 | E-L06 | Low | skipped | `applyMetamagicEffects` swallows unknown metamagic option silently | `/home/ab/projects/DnDnD/internal/combat/metamagic.go:196-214` |
| 345 | E-L07 | Low | skipped | CarefulSpellCreatureCount minimum-1 ignores negative CHA mod gracefully | `/home/ab/projects/DnDnD/internal/combat/metamagic.go:217-228` |
| 346 | E-L08 | Low | skipped | Distant Spell touch -> 30ft does not propagate into `ValidateSpellRange` | `/home/ab/projects/DnDnD/internal/combat/metamagic.go:136-144`; spellcasting.go ... |
| 347 | E-L09 | Low | skipped | Empowered Spell reroll surfaces only the lowest dice (no player choice) | `/home/ab/projects/DnDnD/internal/combat/metamagic.go:248-277` |
| 348 | E-L10 | Low | skipped | Heightened Spell + AoE picks "first affected" without exposing target choice in non-Discord paths | `/home/ab/projects/DnDnD/internal/combat/aoe.go:541-562` |
| 349 | E-L11 | Low | superseded | Twin Spell consumes (spell_level) sorcery points — but spec says "1 for cantrips" | `/home/ab/projects/DnDnD/internal/combat/sorcery.go:38-50` |
| 350 | E-L12 | Low | skipped | FontOfMagic conversion cap check uses `sorcLevel` as max, not feature_uses.max | `/home/ab/projects/DnDnD/internal/combat/sorcery.go:208-211` |
| 351 | E-L13 | Low | skipped | Ritual casting allows any class with feature; Bard requires "Ritual Caster" (Lore subclass) | `/home/ab/projects/DnDnD/internal/combat/spellcasting.go:1235-1242` (`HasRitualC... |
...
| 353 | E-L15 | Low | skipped | AlwaysPreparedSpells subclass list omits Cleric Light, Tempest, etc. and Druid Moon/Stars | `/home/ab/projects/DnDnD/internal/combat/preparation.go:69-93` |
...
| 355 | E-L17 | Low | skipped | Empowered + Twinned combo applies Empowered to both targets but only one reroll budget | `/home/ab/projects/DnDnD/internal/combat/aoe.go:980-1010` |
...
| 357 | E-L19 | Low | skipped | DragMovementCost is always ×2 regardless of number of grappled targets | `/home/ab/projects/DnDnD/internal/combat/grapple_shove.go:373-375` |
| 358 | E-L20 | Low | skipped | Concentration save not enqueued for self-damage from spells like Wrathful Smite | `/home/ab/projects/DnDnD/internal/combat/concentration.go:422-448` (`MaybeCreate... |
| 359 | E-L21 | Low | skipped | Spell DC calculation uses `ProficiencyBonus` from character row without class-progression check | `/home/ab/projects/DnDnD/internal/combat/spellcasting.go:631` |
| 360 | E-L22 | Low | skipped | CastAoE never enforces ValidateSeeTarget on AoE single-creature anchors | `/home/ab/projects/DnDnD/internal/combat/aoe.go:466-468` |
| 361 | F-L01 | Low | skipped | `equipShield` auto-stows off-hand weapon at no cost | /home/ab/projects/DnDnD/internal/combat/equip.go:197-200 |
...
| 363 | F-L03 | Low | skipped | `RecalculateAC` evaluates `ac_formula` parts via Sscanf without error handling | /home/ab/projects/DnDnD/internal/combat/equip.go:467-474 |
| 364 | F-L04 | Low | skipped | Bonus action parsing misses fully-structured `bonus_actions` rows containing only descriptions | /home/ab/projects/DnDnD/internal/combat/turn_builder.go:473-499 |
| 365 | F-L05 | Low | skipped | Summoned-creature short-ID collisions are not detected | /home/ab/projects/DnDnD/internal/combat/summon.go:117-150 |
...
| 375 | G-L06 | Low | skipped | `/check` group-check participant modifier accepts raw int — no validation | internal/check/check.go:254-306 |
| 376 | G-L07 | Low | skipped | `Attune` error string mixes emoji + format verb prefix | internal/inventory/attunement.go:35 |
| 377 | G-L08 | Low | skipped | Inventory `IsPotion` only knows about healing-potion / greater-healing-potion | internal/inventory/service.go:108-114 |
| 378 | G-L09 | Low | skipped | SplitGold zeros pool even if no players found (defensive check exists but bug-prone) | internal/loot/service.go:301-329 |
| 379 | G-L10 | Low | skipped | Shop announcement doesn't show stock counts when present | internal/shops/service.go:131-155 |
| 380 | G-L11 | Low | skipped | Combat recap doesn't tag "[Round X, Turn Y]" inside lines | internal/combat/recap.go:93-116 |
...
| 382 | H-L02 | Low | skipped | LevelUpDetails.NewSpellSlots not surfaced in API response | /home/ab/projects/DnDnD/internal/levelup/handler.go:25 (`LevelUpResponse`) |
| 383 | H-L03 | Low | skipped | Pending DDB import map cache not consulted before durable lookup | /home/ab/projects/DnDnD/internal/ddbimport/service.go:222 (`loadPendingImport`) |
| 384 | H-L04 | Low | skipped | DiscordUserID race-case in HandleASIFeatSelect: lookupFeatName re-lists all feats | /home/ab/projects/DnDnD/internal/discord/asi_handler.go:668-679,792 |
| 385 | H-L05 | Low | skipped | Portal landing page does not list user's existing characters | /home/ab/projects/DnDnD/internal/portal/handler.go:89 (`ServeLanding`) |
| 386 | H-L06 | Low | skipped | ASI prompt button on re-trigger doesn't deduplicate or expire | /home/ab/projects/DnDnD/internal/discord/asi_handler.go:307 (`storePendingChoice... |
| 387 | H-L07 | Low | skipped | `applyFeatProficiencyChoices` saves proficiencies even when caller didn't change them | /home/ab/projects/DnDnD/internal/levelup/service.go:461-491 |
| 388 | I-L01 | Low | skipped | CharCreateHandler accepts campaign_id from request body, not URL | /home/ab/projects/DnDnD/internal/dashboard/charcreate_handler.go:106-138 |
| 389 | I-L02 | Low | skipped | DMCharacterSubmission missing subrace / SubraceID | /home/ab/projects/DnDnD/internal/dashboard/charcreate.go:12-25 |
...
| 391 | I-L04 | Low | skipped | Stat block library handler ignores ?homebrew param | /home/ab/projects/DnDnD/internal/statblocklibrary/handler.go:53-66 |
...
| 398 | I-L11 | Low | skipped | Encounter Builder list query doesn't return display_name in some responses | /home/ab/projects/DnDnD/internal/encounter/handler.go:58-82 |
| 399 | I-L12 | Low | skipped | Narration history endpoint accepts unbounded offset | /home/ab/projects/DnDnD/internal/narration/handler.go:107 |
| 400 | I-L13 | Low | skipped | Message-player history endpoint similarly unbounded | /home/ab/projects/DnDnD/internal/messageplayer/handler.go:96-101 |
...
| 402 | J-L01 | Low | skipped | Open5e cache `idPrefix` (`open5e_`) is checked in only one place; no enforcement on stat-block readers | /home/ab/projects/DnDnD/internal/open5e/cache.go:51 |
| 403 | J-L02 | Low | skipped | EncounterListerAdapter returns `[]string{}` instead of nil for "no campaign", masking the no-active-campaign distinction | /home/ab/projects/DnDnD/cmd/dndnd/main.go:248-251 + 268-272 |
| 404 | J-L03 | Low | skipped | WS client EncounterID query param is not UUID-validated | /home/ab/projects/DnDnD/internal/dashboard/ws.go:135 |
| 405 | J-L04 | Low | skipped | dm-queue PgStore.ListPending uses `context.Background()` from `Notifier.ListPending`/`Get` | /home/ab/projects/DnDnD/internal/dmqueue/notifier.go:222-229, 320-327 |
| 406 | J-L05 | Low | skipped | E2E `SeedDMApproval` bypasses dashboard approval HTTP endpoint | /home/ab/projects/DnDnD/cmd/dndnd/e2e_harness_test.go:168-184 |
| 407 | J-L06 | Low | skipped | Tiled import silently coerces `tilesets` field to `[]any` even when caller supplies an object | /home/ab/projects/DnDnD/internal/gamemap/import.go:69-72 |
...
| 409 | J-L08 | Low | skipped | Exploration `EndExploration` doesn't notify dashboard / clear PCs | /home/ab/projects/DnDnD/internal/exploration/service.go:172-185 |
| 410 | J-L09 | Low | skipped | Reaction handler doesn't return `ErrItemNotFound` from `cancelDMQueueItem` for missing entries | /home/ab/projects/DnDnD/internal/discord/reaction_handler.go:257-269 |
| 411 | J-L10 | Low | skipped | Combat enemy-turn notifier label fallback when SetEncounterLookup is unset | /home/ab/projects/DnDnD/internal/discord/enemy_turn_notifier.go (SetEncounterLoo... |
| 412 | J-L11 | Low | skipped | Health endpoint `/health` only reports two subsystems (db, discord); spec implies more | /home/ab/projects/DnDnD/cmd/dndnd/main.go:1336 (`health.Register("discord", …)`) |
| 413 | J-L12 | Low | skipped | Errorlog Entry has no Severity field; spec asks for severity | /home/ab/projects/DnDnD/internal/errorlog/recorder.go:18-29 |
| 414 | J-L13 | Low | done | `dmqueue.Sender` doesn't wrap message-too-long; long whispers will fail at Discord's 2000-char limit | /home/ab/projects/DnDnD/internal/dmqueue/sender.go (no splitting) |
...
| 416 | J-L15 | Low | skipped | Snapshot.Build does GetEncounter + ListCombatants + GetTurn in three trips per publish | /home/ab/projects/DnDnD/internal/dashboard/snapshot.go:52-83 |
| 417 | J-L16 | Low | skipped | WS writer uses `r.Context()` for write deadlines, but request context is cancelled on disconnect | /home/ab/projects/DnDnD/internal/dashboard/ws.go:146-148 |
| 418 | J-L17 | Low | skipped | CampaignAnnouncer announcement is best-effort with no logging | /home/ab/projects/DnDnD/internal/campaign/service.go:192-195 |
| 419 | J-L18 | Low | skipped | DM-queue inbox list doesn't paginate | /home/ab/projects/DnDnD/internal/dmqueue/pgstore.go:159-164 (ListAllPendingDMQue... |
| 420 | J-L19 | Low | skipped | dmqueueChannelResolver and channel_ids are not validated to be in the bot-accessible guild | /home/ab/projects/DnDnD/cmd/dndnd/main.go:302 (`newDMQueueChannelResolver`) |
| 421 | J-L20 | Low | skipped | Phase 118c CI guard comment present but no actual CI workflow file enforces it | /home/ab/projects/DnDnD/docs/phases.md (Phase 118c "load-bearing deliverable") |
| 422 | J-L21 | Low | skipped | /reaction in exploration mode is allowed even though spec ties reactions to combat | /home/ab/projects/DnDnD/internal/discord/reaction_handler.go (no encounter mode ... |
| 423 | J-L22 | Low | skipped | Open5e cache "manual" resolution default isn't surfaced to DM | /home/ab/projects/DnDnD/internal/open5e/cache.go:215-225 |
| 424 | J-L23 | Low | skipped | CampaignAnnouncer story-channel resolution uses Channel*Send rather than the resolved poster's split logic | /home/ab/projects/DnDnD/internal/discord/campaign_announcer.go:30 |
| 425 | J-L24 | Low | skipped | Exploration spawn assignment is row-major; spec doesn't dictate ordering and may surprise DMs | /home/ab/projects/DnDnD/internal/exploration/spawn.go (AssignPCsToSpawnZones) |
| 426 | J-L25 | Low | skipped | Phase 106f "remove passthroughMiddleware" — still defined and exported in main.go | /home/ab/projects/DnDnD/cmd/dndnd/main.go:319 |
| 427 | cross-cut-L01 | Low | done | `ProficiencyBonus(0)` returns 0; `ProficiencyBonus(21)` also returns 0 | `internal/character/stats.go:134-139`. |
| 428 | cross-cut-L02 | Low | skipped | `RollDeathSave` returns no `DeathSaves` on nat-20 (relies on caller resetting) | `internal/combat/deathsave.go:88-98` returns an |
| 429 | cross-cut-L03 | Low | skipped | Twinned Spell cost for cantrips is 1 SP but no AOE / single-target restriction is enforced | `internal/combat/sorcery.go:38-50` |
