...
| 2 | A-C02 | Critical | in_progress | Dashboard approval endpoints aren't scoped to the DM's own campaign | internal/dashboard/approval_handler.go:230-338 (Approve/Reject/RequestChanges) |
