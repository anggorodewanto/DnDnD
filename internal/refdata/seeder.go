...
func weaponSeeds() []UpsertWeaponParams {
	return []UpsertWeaponParams{
		...
		{ID: "greatclub", Name: "Greatclub", Damage: "1d8", DamageType: "bludgeoning", WeightLb: optFloat(10), Properties: []string{"two-handed"}, WeaponType: "simple_melee", Mastery: "push"},
		{ID: "handaxe", Name: "Handaxe", Damage: "1d6", DamageType: "slashing", WeightLb: optFloat(2), Properties: []string{"light", "thrown"}, RangeNormalFt: optInt(20), RangeLongFt: optInt(60), WeaponType: "simple_melee", Mastery: "vex"},
		{ID: "javelin", Name: "Javelin", Damage: "1d6", DamageType: "piercing", WeightLb: optFloat(2), Properties: []string{"thrown"}, RangeNormalFt: optInt(30), RangeLongFt: optInt(120), WeaponType: "simple_melee", Mastery: "slow"},
		{ID: "light-hammer", Name: "Light hammer", Damage: "1d4", DamageType: "bludgeoning", WeightLb: optFloat(2), Properties: []string{"light", "thrown"}, RangeNormalFt: optInt(20), RangeLongFt: optInt(60), WeaponType: "simple_melee", Mastery: "nick"},
		{ID: "mace", Name: "Mace", Damage: "1d6", DamageType: "bludgeoning", WeightLb: optFloat(4), Properties: []string{}, WeaponType: "simple_melee", Mastery: "sap"},
		{ID: "quarterstaff", Name: "Quarterstaff", Damage: "1d6", DamageType: "bludgeoning", WeightLb: optFloat(4), Properties: []string{"versatile"}, VersatileDamage: optStr("1d8"), WeaponType: "simple_melee", Mastery: "topple"},
		...
		{ID: "glaive", Name: "Glaive", Damage: "1d10", DamageType: "slashing", WeightLb: optFloat(6), Properties: []string{"heavy", "reach", "two-handed"}, WeaponType: "martial_melee", Mastery: "graze"},
		{ID: "greataxe", Name: "Greataxe", Damage: "1d12", DamageType: "slashing", WeightLb: optFloat(7), Properties: []string{"heavy", "two-handed"}, WeaponType: "martial_melee", Mastery: "cleave"},
		{ID: "greatsword", Name: "Greatsword", Damage: "2d6", DamageType: "slashing", WeightLb: optFloat(6), Properties: []string{"heavy", "two-handed"}, WeaponType: "martial_melee", Mastery: "graze"},
		{ID: "halberd", Name: "Halberd", Damage: "1d10", DamageType: "slashing", WeightLb: optFloat(6), Properties: []string{"heavy", "reach", "two-handed"}, WeaponType: "martial_melee", Mastery: "cleave"},
		{ID: "lance", Name: "Lance", Damage: "1d12", DamageType: "piercing", WeightLb: optFloat(6), Properties: []string{"reach", "special"}, WeaponType: "martial_melee", Mastery: "topple"},
		{ID: "longsword", Name: "Longsword", Damage: "1d8", DamageType: "slashing", WeightLb: optFloat(3), Properties: []string{"versatile"}, VersatileDamage: optStr("1d10"), WeaponType: "martial_melee", Mastery: "sap"},
		{ID: "maul", Name: "Maul", Damage: "2d6", DamageType: "bludgeoning", WeightLb: optFloat(10), Properties: []string{"heavy", "two-handed"}, WeaponType: "martial_melee", Mastery: "topple"},
		{ID: "morningstar", Name: "Morningstar", Damage: "1d8", DamageType: "piercing", WeightLb: optFloat(4), Properties: []string{}, WeaponType: "martial_melee", Mastery: "sap"},
		{ID: "pike", Name: "Pike", Damage: "1d10", DamageType: "piercing", WeightLb: optFloat(18), Properties: []string{"heavy", "reach", "two-handed"}, WeaponType: "martial_melee", Mastery: "push"},
		{ID: "rapier", Name: "Rapier", Damage: "1d8", DamageType: "piercing", WeightLb: optFloat(2), Properties: []string{"finesse"}, WeaponType: "martial_melee", Mastery: "vex"},
		{ID: "scimitar", Name: "Scimitar", Damage: "1d6", DamageType: "slashing", WeightLb: optFloat(3), Properties: []string{"finesse", "light"}, WeaponType: "martial_melee", Mastery: "nick"},
		{ID: "shortsword", Name: "Shortsword", Damage: "1d6", DamageType: "piercing", WeightLb: optFloat(2), Properties: []string{"finesse", "light"}, WeaponType: "martial_melee", Mastery: "vex"},
		{ID: "trident", Name: "Trident", Damage: "1d6", DamageType: "piercing", WeightLb: optFloat(4), Properties: []string{"thrown", "versatile"}, RangeNormalFt: optInt(20), RangeLongFt: optInt(60), VersatileDamage: optStr("1d8"), WeaponType: "martial_melee", Mastery: "topple"},
		{ID: "war-pick", Name: "War pick", Damage: "1d8", DamageType: "piercing", WeightLb: optFloat(2), Properties: []string{}, WeaponType: "martial_melee", Mastery: "sap"},
...
func seedConditions(ctx context.Context, q *Queries) error {
	conditions := []UpsertConditionParams{
		...
		},
		{
			...
			Description: "Exhaustion is measured in six levels. While a creature has any levels of exhaustion, its D20 Tests (ability checks, attack rolls, and saving throws) take a penalty equal to 2 times its exhaustion level, and its Speed is reduced by 5 feet times its exhaustion level. At level 6 the creature dies. Finishing a long rest removes 1 level of exhaustion.",
			MechanicalEffects: mustJSON([]MechanicalEffect{
				{EffectType: "exhaustion_level", Value: "1", Description: "-2 to all d20 tests, Speed -5 ft"},
				{EffectType: "exhaustion_level", Value: "2", Description: "-4 to all d20 tests, Speed -10 ft"},
				{EffectType: "exhaustion_level", Value: "3", Description: "-6 to all d20 tests, Speed -15 ft"},
				{EffectType: "exhaustion_level", Value: "4", Description: "-8 to all d20 tests, Speed -20 ft"},
				{EffectType: "exhaustion_level", Value: "5", Description: "-10 to all d20 tests, Speed -25 ft"},
