...
func TestIntegration_MigrateDown(t *testing.T) {
	...
	for _, name := range []string{
		"add_combatant_rage_started_round",
		"add_pending_initiative_dm_queue_item_id",
		"create_pending_initiatives",
		"character_delete_cascade",
		"add_characters_conditions",
		"add_review_before_to_player_characters",
		"add_weapon_ammunition_id",
		"create_items",
		"create_initiative_tracker_messages",
		"create_open5e_custom_sources",
		"create_dm_active_campaign",
		"create_character_drafts",
		"add_weapon_mastery",
		"add_characters_level_index",
		"add_map_dimension_check",
		"add_reaction_dm_queue_item_id",
		"add_pending_saves_cover_bonus",
		...
		"make_player_characters_unique_partial",
		"add_combatant_next_attack_adv_override",
	...
	// Roll back the encounters migration
	if err := database.MigrateDown(db, dbfs.Migrations); err != nil {
